...
var Spinner = function (_a) {
    ...
    return (React.createElement(Container$1, null,
        React.createElement("img", { src: "/images/fomo/spinner.gif", width: size, alt: "Loading..." })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null, isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "FomoBSC home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "FomoBSC home page" }, innerLogo))));
};
...
var AccountModal = function (_a) {
    ...
    var _d = useState(true), first = _d[0], setFirst = _d[1];
    ...
    return (React.createElement(Modal, { title: title ? title : "Your Wallet", onDismiss: onDismiss },
        ...
        React.createElement(StyledInput, { disabled: (profile === null || profile === void 0 ? void 0 : profile.affiliateAddress) !== undefined && (profile === null || profile === void 0 ? void 0 : profile.affiliateAddress) !== "0x0000000000000000000000000000000000000000", value: affiliate, placeholder: "Affiliate Address", onChange: handleAffiliate }),
        React.createElement(Flex, { justifyContent: "center", marginBottom: "16px" },
            React.createElement(Button, { height: "32px", width: "100%", disabled: !usernameValidation || !affiliateValidation, variant: "tertiary", onClick: function () {
                    localStorage.setItem(account, username);
                    localStorage.setItem("FOMO_AFFILIATE", affiliate);
                    onDismiss();
                } }, registerText)),
        React.createElement(Flex, { justifyContent: "center" },
            React.createElement(StyledButton$1, { height: "32px", width: "100%", variant: "tertiary", onClick: function () {
                    logout();
