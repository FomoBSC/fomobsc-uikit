...
var Icon$r = function (props) {
    return (React.createElement("svg", { width: "52", height: "43", viewBox: "0 0 52 43", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("path", { d: "M26.9652 18.852L26.044 31.5208L10.3052 7.61713L26.9652 18.852Z", fill: "#EEB825" }),
        React.createElement("path", { d: "M44.7104 10.3195L26.9652 18.8521L26.044 31.5209L44.7104 10.3195Z", fill: "#EEB825" }),
        React.createElement("path", { d: "M10.3052 7.61716L28.472 0.266418L44.7104 10.3195L26.9652 18.8521L10.3052 7.61716Z", fill: "#231F20" }),
        React.createElement("path", { d: "M22.8744 7.34931L27.7772 5.26148L32.2974 8.0899L35.1469 6.8766L27.9957 2.40942L20.2434 5.70268L22.8744 7.34931Z", fill: "#F3BA2C" }),
        React.createElement("path", { d: "M15.3797 7.77477L18.2292 6.56146L20.8602 8.20021L18.0106 9.41352L15.3797 7.77477Z", fill: "#F3BA2C" }),
        React.createElement("path", { d: "M22.7182 9.36621L27.2385 12.1868L32.1412 10.0989L34.7722 11.7456L27.0199 15.0388L19.8687 10.5795L19.8609 10.5716L22.7182 9.36621Z", fill: "#F3BA2C" }),
        React.createElement("path", { d: "M34.1554 9.24804L37.005 8.03473L39.6359 9.68136L36.7864 10.8868L34.1554 9.24804Z", fill: "#F3BA2C" }),
        React.createElement("path", { d: "M30.2832 8.94077L27.6132 7.27051L25.4819 8.22382L25.2321 8.32624L24.7246 8.53896L27.3946 10.2014L30.2832 8.97229", fill: "#F3BA2C" })));
};
...
var ButtonMenuItem = function (_a) {
    ...
    return React.createElement(Button, __assign({ as: as, variant: "tertiary" }, props));
};
...
var StyledHeading = styled(Heading)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  color: white;\n  font-size: 16px;\n  font-weight: 400;\n"], ["\n  color: white;\n  font-size: 16px;\n  font-weight: 400;\n"])));
...
var Icon$15 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M4 22v-20h16v11.543c0 4.107-6 2.457-6 2.457s1.518 6-2.638 6h-7.362zm18-7.614v-14.386h-20v24h10.189c3.163 0 9.811-7.223 9.811-9.614zm-5-1.386h-10v-1h10v1zm0-4h-10v1h10v-1zm0-3h-10v1h10v-1z" })));
};

var Icon$16 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M24 24h-24v-24h24v24zm-4.03-5.649v-.269l-1.247-1.224c-.11-.084-.165-.222-.142-.359v-8.998c-.023-.137.032-.275.142-.359l1.277-1.224v-.269h-4.422l-3.152 7.863-3.586-7.863h-4.638v.269l1.494 1.799c.146.133.221.327.201.523v7.072c.044.255-.037.516-.216.702l-1.681 2.038v.269h4.766v-.269l-1.681-2.038c-.181-.186-.266-.445-.232-.702v-6.116l4.183 9.125h.486l3.593-9.125v7.273c0 .194 0 .232-.127.359l-1.292 1.254v.269h6.274z" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "FomoBSC home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "FomoBSC home page" }, innerLogo))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "/" },
        React.createElement(Icon$y, { width: "24px" }),
        React.createElement(Text, { color: "textSubtle", ml: "8px" }, "$" + cakePriceUsd.toFixed(2)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { width: "100%", variant: "tertiary", onClick: function () {
        ...
        React.createElement(Text, { fontSize: "14px", color: "black", mr: "16px" }, title),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://academy.binance.com/en/articles/how-to-get-started-with-binance-smart-chain-bsc", external: true },
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: title ? title : "Your Wallet", onDismiss: onDismiss },
        ...
        profile && profile.affiliateAddress !== undefined && (React.createElement(React.Fragment, null,
            ...
            React.createElement(Flex, { mb: "32px" },
                React.createElement(LinkExternal, { fontSize: "12px", small: true, href: "https://bscscan.com/address/" + profile.affiliateAddress, mr: "16px" }, "View on BscScan"),
                React.createElement(CopyToClipboard, { toCopy: profile.affiliateAddress ? profile.affiliateAddress : '' }, "Copy Address")))),
...
var useWalletModal = function (login, logout, account, profile) {
    ...
    var onPresentAccountModal = useModal(React.createElement(AccountModal, { profile: profile, account: account || "", logout: logout }))[0];
...
var UserBlock$1 = React.memo(UserBlock, function (prevProps, nextProps) { return prevProps.profile === nextProps.profile && prevProps.account === nextProps.account; });
