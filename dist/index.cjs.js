...
var Icon$r = function (props) {
    return (React__default['default'].createElement("svg", { width: "52", height: "43", viewBox: "0 0 52 43", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React__default['default'].createElement("path", { d: "M26.9652 18.852L26.044 31.5208L10.3052 7.61713L26.9652 18.852Z", fill: "#EEB825" }),
        React__default['default'].createElement("path", { d: "M44.7104 10.3195L26.9652 18.8521L26.044 31.5209L44.7104 10.3195Z", fill: "#EEB825" }),
        React__default['default'].createElement("path", { d: "M10.3052 7.61716L28.472 0.266418L44.7104 10.3195L26.9652 18.8521L10.3052 7.61716Z", fill: "#231F20" }),
        React__default['default'].createElement("path", { d: "M22.8744 7.34931L27.7772 5.26148L32.2974 8.0899L35.1469 6.8766L27.9957 2.40942L20.2434 5.70268L22.8744 7.34931Z", fill: "#F3BA2C" }),
        React__default['default'].createElement("path", { d: "M15.3797 7.77477L18.2292 6.56146L20.8602 8.20021L18.0106 9.41352L15.3797 7.77477Z", fill: "#F3BA2C" }),
        React__default['default'].createElement("path", { d: "M22.7182 9.36621L27.2385 12.1868L32.1412 10.0989L34.7722 11.7456L27.0199 15.0388L19.8687 10.5795L19.8609 10.5716L22.7182 9.36621Z", fill: "#F3BA2C" }),
        React__default['default'].createElement("path", { d: "M34.1554 9.24804L37.005 8.03473L39.6359 9.68136L36.7864 10.8868L34.1554 9.24804Z", fill: "#F3BA2C" }),
        React__default['default'].createElement("path", { d: "M30.2832 8.94077L27.6132 7.27051L25.4819 8.22382L25.2321 8.32624L24.7246 8.53896L27.3946 10.2014L30.2832 8.97229", fill: "#F3BA2C" })));
};
...
var Icon$y = function (props) {
    return (React__default['default'].createElement("svg", { width: "24", height: "24", viewBox: "0 0 36 35", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React__default['default'].createElement("path", { d: "M17.9457 34.842C27.5665 34.842 35.3657 27.0428 35.3657 17.422C35.3657 7.80115 27.5665 0.00195312 17.9457 0.00195312C8.3249 0.00195312 0.525696 7.80115 0.525696 17.422C0.525696 27.0428 8.3249 34.842 17.9457 34.842Z", fill: "#EEB825" }),
        React__default['default'].createElement("path", { d: "M28.1757 11.212L25.8757 9.00196L26.8757 8.00196C27.0551 7.82086 27.1653 7.58262 27.1872 7.32867C27.2091 7.07472 27.1414 6.82112 26.9957 6.61196C26.9051 6.4875 26.7883 6.38446 26.6535 6.31016C26.5188 6.23585 26.3693 6.19208 26.2157 6.18196C26.0626 6.1733 25.9093 6.19736 25.7662 6.25254C25.6231 6.30771 25.4934 6.39274 25.3857 6.50196L16.5257 15.672L17.0257 16.152L17.5357 16.662L18.0457 17.142L21.9857 13.062L24.2757 15.272C24.3403 15.3386 24.4182 15.3908 24.5044 15.4253C24.5905 15.4597 24.683 15.4756 24.7757 15.472C24.8672 15.4712 24.9577 15.4522 25.0418 15.4162C25.1259 15.3801 25.202 15.3277 25.2657 15.262L25.7557 14.752C25.8208 14.6863 25.8721 14.6082 25.9065 14.5223C25.9408 14.4364 25.9576 14.3445 25.9557 14.252C25.9561 14.1603 25.9377 14.0695 25.9015 13.9852C25.8654
        React__default['default'].createElement("path", { d: "M17.2757 17.4019L16.2757 16.4019L15.7757 15.9119C15.7422 15.8809 15.7028 15.857 15.6599 15.8415C15.6169 15.826 15.5713 15.8194 15.5257 15.8219C15.4328 15.8227 15.3435 15.8584 15.2757 15.9219C15.2055 15.9943 15.1661 16.0911 15.1657 16.1919C15.167 16.2818 15.2028 16.3678 15.2657 16.4319L15.7757 16.9219L16.7757 17.9219L17.2957 18.4119C17.3261 18.445 17.3633 18.4711 17.4047 18.4883C17.4462 18.5056 17.4909 18.5136 17.5357 18.5119C17.6286 18.5112 17.7179 18.4755 17.7857 18.4119C17.8559 18.3395 17.8953 18.2428 17.8957 18.1419C17.8974 18.0971 17.8894 18.0524 17.8721 18.011C17.8548 17.9695 17.8288 17.9323 17.7957 17.9019L17.2757 17.4019Z", fill: "#010101" })));
};
...
var ButtonMenuItem = function (_a) {
    var _b = _a.isActive, isActive = _b === void 0 ? false : _b, _c = _a.variant, variant = _c === void 0 ? variants.TERTIARY : _c, as = _a.as, props = __rest(_a, ["isActive", "variant", "as"]);
    if (!isActive) {
    ...
    return React__default['default'].createElement(Button, __assign({ as: as, variant: "tertiary" }, props));
};
...
var StyledHeading = styled__default['default'](Heading)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  color: white;\n  font-size: 16px;\n  font-weight: 400;\n"], ["\n  color: white;\n  font-size: 16px;\n  font-weight: 400;\n"])));
    ...
    return (React__default['default'].createElement(StyledModal, null,
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                ...
                React__default['default'].createElement(StyledHeading, null, title)),
...
var templateObject_1$x, templateObject_2$b, templateObject_3$5, templateObject_4$3;
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "FomoBSC home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "FomoBSC home page" }, innerLogo))));
};
...
var WalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { width: "100%", variant: "tertiary", onClick: function () {
        ...
        React__default['default'].createElement(Text, { fontSize: "14px", color: "black", mr: "16px" }, title),
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://academy.binance.com/en/articles/how-to-get-started-with-binance-smart-chain-bsc", external: true },
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: title ? title : "Your Wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "24px" },
            ...
            React__default['default'].createElement(CopyToClipboard, { toCopy: "fomobsc.com?affiliate=" + account }, "Copy Affiliate Link")),
        ...
        React__default['default'].createElement(StyledInput, { disabled: profile && profile.username != "", value: username, placeholder: "Username", onChange: handleUsername }),
        ...
        React__default['default'].createElement(StyledInput, { disabled: profile && profile.affiliateAddress != "", value: affiliate, placeholder: "Affiliate Address", onChange: handleAffiliate }),
...
var useWalletModal = function (login, logout, account, profile) {
    ...
    var onPresentAccountModal = useModal(React__default['default'].createElement(AccountModal, { profile: profile, account: account || "", logout: logout }))[0];
...
var UserBlock$1 = React__default['default'].memo(UserBlock, function (prevProps, nextProps) { return prevProps.profile === nextProps.profile && prevProps.account === nextProps.account; });
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock$1, { profile: profile, account: account, login: login, logout: logout }))),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EEB825", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#000000", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#EEB825", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#FFFFFF", borderColor: "#524B63", card: "#000000", gradients: {
